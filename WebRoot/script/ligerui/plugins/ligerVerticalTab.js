...
* http://ligerui.com
*  
* 从ligerTab复制代码。主要修改样式，统一添加上vertical前缀 @time 2012-07-31 @author lucifer
* 
*/
(function ($)
{

    $.fn.ligerVerticalTab = function (options)
    {
        return $.ligerui.run.call(this, "ligerVerticalTab", arguments);
    };

    $.fn.ligerGetVerticalTabManager = function ()
    {
        return $.ligerui.run.call(this, "ligerGetVerticalTabManager", arguments);
    };

    $.ligerDefaults.VerticalTab = {
        height: null,
        heightDiff: 0, // 高度补差 
    ...
    $.ligerDefaults.VerticalTabString = {
        closeMessage: "关闭当前页",
    ...
    $.ligerMethos.VerticalTab = {};

    $.ligerui.controls.VerticalTab = function (element, options)
    {
        $.ligerui.controls.VerticalTab.base.constructor.call(this, element, options);
    };
    $.ligerui.controls.VerticalTab.ligerExtend($.ligerui.core.UIComponent, {
        __getType: function ()
        {
            return 'VerticalTab';
        },
        ...
        {
            return $.ligerMethos.VerticalTab;
        },
        _render: function ()
        {
            ...
            g.tab.content = $('<div class="vertical-l-tab-content"></div>');
            //TODO cx 外层div宽度计算有问题
            g.tab.content.width($(window).width() - 177);
            $("> div", g.tab).appendTo(g.tab.content);
            g.tab.content.appendTo(g.tab);
            g.tab.links = $('<div class="vertical-l-tab-links"><ul style="left: 0px; "></ul></div>');
            ...
            {
                var li = $('<li class=""><a></a><div class="vertical-l-tab-links-item-left"></div><div class="vertical-l-tab-links-item-right"></div></li>');
                ...
                if (showClose)
                {
                    li.append("<div class='vertical-l-tab-links-item-close'></div>");
                }
                $("> ul", g.tab.links).append(li);
                if (!contentitem.hasClass("vertical-l-tab-content-item")) contentitem.addClass("vertical-l-tab-content-item");
                ...
                if (contentitem.find("iframe").length > 0)
                {
                    ...
                    {
                        if (contentitem.find(".vertical-l-tab-loading:first").length == 0)
                            contentitem.prepend("<div class='vertical-l-tab-loading' style='display:block;'></div>");
                        var iframeloading = $(".vertical-l-tab-loading:first", contentitem);
            ...
            g.tab.bind('dblclick.tab', function (e)
            {
                ...
                if (tagName == "a")
                {
                    ...
                    var allowClose = $(obj).parent().find("div.vertical-l-tab-links-item-close").length ? true : false;
                    if (allowClose)
                    {
        ...
        {
            var g = this, p = this.options;
            g.droptip = g.droptip || $("<div class='vertical-l-tab-drag-droptip' style='display:none'><div class='vertical-l-drop-move-up'></div><div class='vertical-l-drop-move-down'></div></div>").appendTo('body');
            var drag = $(tabItemDom).ligerDrag(
            {
                ...
                proxy: function ()
                {
                    ...
                    g.dragproxy = $("<div class='vertical-l-tab-drag-proxy' style='display:none'><div class='vertical-l-drop-icon l-drop-no'></div></div>").appendTo('body');
                ...
                onStartDrag: function (current, e)
                {
                    ...
                    if ($(obj).hasClass("vertical-l-tab-links-item-close")) return false;
                },
                onDrag: function (current, e)
                {
                    ...
                    tabItems.each(function (i, item)
                    {
                        ...
                        if (pageX > range.left && pageX < range.right && pageY > range.top && pageY < range.bottom)
                        {
                            ...
                            g.dropIn = i;
                            g.dragproxy.find(".vertical-l-drop-icon").removeClass("vertical-l-drop-no").addClass("vertical-l-drop-yes");
                        }
                        else
                        {
                            g.dropIn = -1;
                            g.droptip.hide();
                            g.dragproxy.find(".vertical-l-drop-icon").removeClass("vertical-l-drop-yes").addClass("vertical-l-drop-no");
                        }
                    });
                },
        ...
        setTabButton: function ()
        {
            ...
            {
                g.tab.links.append('<div class="vertical-l-tab-links-left"></div><div class="vertical-l-tab-links-right"></div>');
                g.setTabButtonEven();
                return true;
            } else
            {
                g.tab.links.ul.animate({ left: 0 });
                $(".vertical-l-tab-links-left,.vertical-l-tab-links-right", g.tab.links).remove();
                return false;
            }
        },
        ...
        {
            var g = this, p = this.options;
            $(".vertical-l-tab-links-left", g.tab.links).hover(function ()
            {
                $(this).addClass("vertical-l-tab-links-left-over");
            }, function ()
            {
                $(this).removeClass("vertical-l-tab-links-left-over");
            }).click(function ()
            {
                g.moveToPrevTabItem();
            });
            $(".vertical-l-tab-links-right", g.tab.links).hover(function ()
            {
                $(this).addClass("vertical-l-tab-links-right-over");
            }, function ()
            {
                $(this).removeClass("vertical-l-tab-links-right-over");
            }).click(function ()
            {
                g.moveToNextTabItem();
            });
        ...
        {
            var g = this, p = this.options;
            var btnWitdth = $(".vertical-l-tab-links-left", g.tab.links).width();
        ...
        {
            var g = this, p = this.options;
            var btnWitdth = $(".vertical-l-tab-links-right", g.tab).width();
            var sumwidth = 0;
        ...
        overrideTabItem: function (targettabid, options)
        {
            ...
            var contentitem = $(".vertical-l-tab-content-item[tabid=" + targettabid + "]", g.tab.content);
            ...
            if (showClose == false) $(".vertical-l-tab-links-item-close", tabitem).remove();
            else
            {
                if ($(".l-tab-links-item-close", tabitem).length == 0)
                    tabitem.append("<div class='vertical-l-tab-links-item-close'></div>");
            }
        ...
        selectTabItem: function (tabid)
        {
            ...
            if (g.trigger('beforeSelectTabItem', [tabid]) == false)
                return false;
            g.selectedTabId = tabid;
            $("> .vertical-l-tab-content-item[tabid=" + tabid + "]", g.tab.content).show().siblings().hide();
        ...
        moveToLastTabItem: function ()
        {
            ...
            if (sumwidth > mainwidth)
            {
                var btnWitdth = $(".vertical-l-tab-links-right", g.tab.links).width();
        ...
        addTabItem: function (options)
        {
            ...
            var tabitem = $("<li><a></a><div class='vertical-l-tab-links-item-left'></div><div class='vertical-l-tab-links-item-right'></div><div class='vertical-l-tab-links-item-close'></div></li>");
            var contentitem = $("<div class='vertical-l-tab-content-item'><div class='vertical-l-tab-loading' style='display:block;'></div><iframe frameborder='0'></iframe></div>");
        ...
        _addTabItemEvent: function (tabitem)
        {
            ...
            $(".vertical-l-tab-links-item-close", tabitem).hover(function ()
            {
                $(this).addClass("vertical-l-tab-links-item-close-over");
            }, function ()
            {
                $(this).removeClass("vertical-l-tab-links-item-close-over");
            }).click(function ()
            {
        ...
        removeTabItem: function (tabid)
        {
            ...
            {
                $(".vertical-l-tab-content-item[tabid=" + tabid + "]", g.tab.content).prev().show();
                $("li[tabid=" + tabid + "]", g.tab.links.ul).prev().addClass("l-selected").siblings().removeClass("l-selected");
            }
            $(".vertical-l-tab-content-item[tabid=" + tabid + "]", g.tab.content).remove();
        ...
        getTabidList: function (notabid, noclose)
        {
            ...
            $("> li", g.tab.links.ul).each(function ()
            {
                if ($(this).attr("tabid")
                        ...
                        && (!noclose || $(".vertical-l-tab-links-item-close", this).length > 0))
                {
        ...
        {
            var g = this, p = this.options;
            var contentitem = $(".vertical-l-tab-content-item[tabid=" + tabid + "]");
            var iframeloading = $(".vertical-l-tab-loading:first", contentitem);
            var iframe = $("iframe:first", contentitem);
