...
(function ($)
{
    ...
    $.ligerui.controls.Layout.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                g.top = $("> div[position=top]", g.layout).wrap('<div class="l-layout-top" style="top:0px;left: 0px;"></div>').parent();
            ...
            {
                g.bottom = $("> div[position=bottom]", g.layout).wrap('<div class="l-layout-bottom" style="left: 0px;"></div>').parent();
            ...
            g.leftCollapse = $('<div class="l-layout-collapse-left" style="display: none; "><div class="l-layout-collapse-left-toggle"></div><div class="l-layout-collapse-left-title"></div></div>');
            ...
            g.leftCollapse.title = $("> .l-layout-collapse-left-title", g.leftCollapse);
            g.leftCollapse.title.html($(".l-layout-header-inner", g.left.header).html());
        ...
        _setCollapse: function ()
        {
            ...
            g.leftCollapse.title.click(function ()
            {
                g.setLeftCollapse(false);
            });
